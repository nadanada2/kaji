      ...
      >
        <div className="mx-auto flex h-[66px] max-w-[1440px] items-center justify-between px-6 lg:px-10">
          <Link href="/" className="flex items-center gap-3 shrink-0">
            <div className="w-8 h-8 rounded-full flex items-center justify-center" style={{ backgroundColor: "#1E3A5F" }}>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative" ref={menuRef}>
              {isAuthenticated ? (
                <>
                  ...
                  >
                    <div className="w-6 h-6 rounded-full flex items-center justify-center" style={{ backgroundColor: "#1E3A5F" }}>
                    ...
                    <ChevronDown className={`w-3.5 h-3.5 transition-transform ${showUserMenu ? "rotate-180" : ""}`} style={{ color: "#8892A4" }} />
                  </button>

                  {showUserMenu && (
                    <div
                      className="absolute right-0 mt-2 w-56 rounded-2xl border overflow-hidden shadow-[0_8px_40px_rgba(15,23,42,0.14)] z-50"
            ...
            >
              ...
              {cart.length > 0 && (
                <span
                  className="absolute -top-1.5 -right-1.5 flex items-center justify-center rounded-full text-[9px] font-bold min-w-[18px] h-[18px] px-1"
